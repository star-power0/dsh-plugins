...
export interface ThemeSection {
   ...
   * darkInk* overrides dark mode only, '' = follow the light value). Primary =
   * 聊天正文/侧栏会话标题, secondary = 副标题/元信息/任务步骤, tertiary =
   * 时间戳/弱说明/注入文字, caption = 最小说明, dimmed = 更浅辅助文字.
   */
  inkPrimary: string | undefined
  inkSecondary: string | undefined
  inkTertiary: string | undefined
  inkCaption: string | undefined
  inkDimmed: string | undefined
  darkInkPrimary: string | undefined
  darkInkSecondary: string | undefined
  darkInkTertiary: string | undefined
  darkInkCaption: string | undefined
  darkInkDimmed: string | undefined
  /**
