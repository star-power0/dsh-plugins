...
export type AppearanceKey =
  ...
  | 'groupInk' | 'inkHint' | 'inkLightHeading' | 'inkDarkHeading' | 'inkStockPlaceholder' | 'inkFollowLight'
...
export const zh: Record<AppearanceKey, string> = {
  ...
  inkDimmed: '弱化文字',
  groupInk: '文字颜色',
  inkHint: '覆盖官方的中性文字色阶：主文字 = 聊天正文 / 侧栏会话标题 / 面板标题；次要文字 = 副标题 / 列表元信息 / 任务步骤；三级文字 = 时间戳 / 弱化说明 / 上下文注入内容；说明文字 = 最小号说明；弱化文字 = 更浅的辅助文字。留空 = 官方默认。',
  inkLightHeading: '浅色模式',
  inkDarkHeading: '深色模式',
  inkStockPlaceholder: '留空 = 默认',
  inkFollowLight: '留空 = 跟随浅色',
  gradient: '色调渐变',
...
export const en: Record<AppearanceKey, string> = {
  ...
  inkPrimary: 'Primary text',
  inkSecondary: 'Secondary text',
  inkTertiary: 'Tertiary text',
  inkCaption: 'Caption text',
  inkDimmed: 'Dimmed text',
  groupInk: 'Text color',
  inkHint: 'Overrides the official neutral text ladder: primary = chat body / sidebar session titles / panel titles; secondary = subtitles / list metadata / task steps; tertiary = timestamps / soft hints / context-injection text; caption = smallest hints; dimmed = fainter auxiliary text. Empty = official default.',
  inkLightHeading: 'Light mode',
  inkDarkHeading: 'Dark mode',
  inkStockPlaceholder: 'Empty = default',
  inkFollowLight: 'Empty = follow light',
