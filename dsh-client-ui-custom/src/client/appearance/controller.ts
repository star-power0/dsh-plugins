 ...
 * "恢复本组默认" reset). */
export type ParamGroup = 'background' | 'color' | 'surface' | 'typography' | 'ink' | 'refine'
...
const GROUP_NEUTRALS: Readonly<Record<ParamGroup, Partial<ThemeSection>>> = {
  ...
  ink: {
    inkPrimary: DEFAULTS.inkPrimary, inkSecondary: DEFAULTS.inkSecondary,
    inkTertiary: DEFAULTS.inkTertiary, inkCaption: DEFAULTS.inkCaption, inkDimmed: DEFAULTS.inkDimmed,
    darkInkPrimary: DEFAULTS.darkInkPrimary, darkInkSecondary: DEFAULTS.darkInkSecondary,
    darkInkTertiary: DEFAULTS.darkInkTertiary, darkInkCaption: DEFAULTS.darkInkCaption,
    darkInkDimmed: DEFAULTS.darkInkDimmed,
  },
  refine: {
