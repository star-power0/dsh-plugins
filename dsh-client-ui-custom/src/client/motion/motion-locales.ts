...
export type MotionKey =
  | 'nav' | 'title' | 'intro'
  | 'presetTitle' | 'presetDesc'
  | 'presetFluid' | 'presetFluidDesc'
  | 'presetElegant' | 'presetElegantDesc'
  | 'presetMinimal' | 'presetMinimalDesc'
  | 'groupConversation' | 'groupSidebar' | 'groupNewChat' | 'groupSettings'
  | 'toggleTitle' | 'toggleDesc'
  | 'styleTitle' | 'styleDesc'
  | 'styleFadeUp' | 'styleFade' | 'styleRiseScale' | 'styleSlideIn' | 'styleBlurIn' | 'styleScaleIn'
  | 'sidebarStyleTitle' | 'sidebarStyleDesc' | 'styleSlideLeft' | 'styleExpand' | 'styleSlideDown'
  | 'sidebarToggleTitle' | 'sidebarToggleDesc'
  | 'selectionToggleTitle' | 'selectionToggleDesc'
  | 'newChatToggleTitle' | 'newChatToggleDesc'
  | 'newChatStyleTitle' | 'newChatStyleDesc'
  | 'styleReveal' | 'styleBloom' | 'styleZoom'
  | 'settingsToggleTitle' | 'settingsToggleDesc'

/** Simplified Chinese copy. */
export const zh: Record<MotionKey, string> = {
  nav: '动效',
  title: '动效',
  intro: '对话内容的入场动效。',
  presetTitle: '预设方案',
...
/** English copy. */
export const en: Record<MotionKey, string> = {
  nav: 'Motion',
  title: 'Motion',
  ...
  groupConversation: 'Conversation entrance',
  groupSidebar: 'Sidebar',
  groupNewChat: 'New conversation',
  groupSettings: 'Settings interface',
