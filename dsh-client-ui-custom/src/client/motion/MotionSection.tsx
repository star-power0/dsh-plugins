  ...
  return (
    <div className={css.section}>
      ...
      <div className={css.group}>
        <h3 className={css.groupHeading}>{translator('groupConversation')}</h3>
      ...
      <div className={css.group}>
        <h3 className={css.groupHeading}>{translator('groupSidebar')}</h3>
        <div className={`${css.row} ${css.rowDivider}`}>
          <div className={css.rowText}>
      ...
      <div className={css.group}>
        <h3 className={css.groupHeading}>{translator('groupNewChat')}</h3>
        <div className={`${css.row} ${css.rowDivider}`}>
          <div className={css.rowText}>
      ...
      <div className={css.group}>
        <h3 className={css.groupHeading}>{translator('groupSettings')}</h3>
        <div className={`${css.row} ${css.rowDivider}`}>
          <div className={css.rowText}>
