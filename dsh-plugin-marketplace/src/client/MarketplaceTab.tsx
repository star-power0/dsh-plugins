            ...
            <div style={s.installedTop}>
              <div style={s.installedInfo}>
                ...
                <div style={s.installedStatusRow}>
                  ...
                  {entry.linked && entry.patchManaged ? (
                    <span style={s.installedStatusChip} title={t('patchManagedHint')}>{t('patchManagedChip')}</span>
                  ) : null}
                </div>
              </div>
              <div style={s.installedActions}>
                ...
                ) : entry.updateAvailable && entry.packageName !== SELF_PACKAGE && entry.canUpdate ? (
