...
declare module '@deepseek-ai/dsh-typert-protocol' {
  interface TypertRemoteNamespace$6d61726b6574706c616365 {
    ...
    pickDirectory: () => Promise<RemoteResult<MarketplaceResult<MarketplacePickDirectory>>>
  ...
  interface TypertRemoteMap {
    ...
    'marketplace/pickDirectory': () => Promise<RemoteResult<MarketplaceResult<MarketplacePickDirectory>>>
