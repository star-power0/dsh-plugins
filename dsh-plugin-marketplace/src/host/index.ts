...
import { DirectoryPickerCapability, pickDirectoryPath } from './pick-directory.ts'
...
export class MarketplaceService extends TypertRemoteService {
  static inject = ['skills', 'directoryPicker']
  ...
  async pickDirectory(): Promise<MarketplaceResult<MarketplacePickDirectory>> {
    try {
      const picker = (this.ctx as unknown as { directoryPicker?: { capability(): DirectoryPickerCapability } }).directoryPicker
