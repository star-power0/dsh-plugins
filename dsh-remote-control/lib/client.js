	...
	factory: (require) => {
		...
		*/
		...
		async function adminGet(path) {
			return await (await fetch(path, { headers: { accept: "application/json" } })).json();
		}
		...
		const badgeStyle = (on) => ({
			...
			padding: "2px 10px",
			borderRadius: 999,
			background: on ? "color-mix(in srgb, var(--dsw-alias-state-success-primary, #3fb27f) 16%, transparent)" : "var(--dsw-alias-bg-module-platform)",
		...
		const dangerStyle = {
			...buttonStyle,
			color: "var(--dsw-alias-state-danger-primary, #ff7a7a)"
		};
		...
		function PhoneIcon() {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("rect", {
					...
					height: "19",
					rx: "2.5"
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M10.5 18.5h3" })]
			});
		}
		/** 相对时间展示（最近活跃）。 */
		...
		function Panel({ t }) {
			...
			const [issuing, setIssuing] = (0, react.useState)(false);
			const [pair, setPair] = (0, react.useState)(null);
			const [qrDataUrl, setQrDataUrl] = (0, react.useState)("");
			const [devices, setDevices] = (0, react.useState)([]);
			const refresh = (0, react.useCallback)(async () => {
				try {
					const envelope = await adminGet("/remote-control/status");
					if (envelope.ok && envelope.status !== void 0) {
			...
			(0, react.useEffect)(() => {
				...
				let cancelled = false;
				import_browser.toDataURL(pair.urls[0], {
					width: 220,
					margin: 1,
					color: {
						dark: "#101014",
			...
			const issueCode = (0, react.useCallback)(async () => {
				setIssuing(true);
				try {
					const envelope = await adminPost("/remote-control/pair-code", {});
					if (envelope.ok && envelope.code !== void 0) setPair({
						code: envelope.code,
			...
			const revoke = (0, react.useCallback)(async (id) => {
				if (!window.confirm(t("confirmRevoke"))) return;
				if ((await adminPost("/remote-control/revoke", { id })).ok) setDevices((current) => current.filter((device) => device.id !== id));
			}, [t]);
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								style: rowStyle,
								children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: t("gatewayLabel") }),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										style: badgeStyle(listening),
										children: listening ? t("gatewayOn") : t("gatewayOff")
									}),
									listening && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
										style: textStyle,
										children: [
											t("portLabel"),
											" ",
							...
							!loadError && status !== null && status.urls.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								style: textStyle,
								children: t("addressLabel")
							}), status.urls.map((url) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								style: {
									...monoStyle,
									margin: "2px 0"
								},
							...
							!loadError && status !== null && status.urls.length === 0 && listening && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								style: textStyle,
								children: t("noAddress")
							})
						]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							style: rowStyle,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: t("pairCodeLabel") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								style: {
									...buttonStyle,
									marginLeft: "auto"
								...
								children: issuing ? t("issuing") : t("issuePairCode")
							})]
						}), pair !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								style: rowStyle,
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									style: codeStyle,
									children: pair.code
								}), qrDataUrl !== "" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("img", {
									src: qrDataUrl,
									alt: "QR",
									width: 110,
									height: 110,
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								style: textStyle,
								children: status?.publicUrl !== void 0 && status.publicUrl !== "" ? t("scanHintPublic") : t("scanHint")
							}),
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						style: cardStyle,
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: t("devicesLabel") }),
							devices.length === 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								style: textStyle,
								children: t("noDevices")
							}),
							devices.map((device) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								style: {
									...rowStyle,
									borderBottom: "1px solid var(--dsw-alias-border-secondary, #23232b)",
									paddingBottom: 8
								},
								children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(PhoneIcon, {}), device.name]
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
										style: textStyle,
										children: [
											t("lastSeen"),
											" ",
											relativeTime(device.lastSeen, t)
										]
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
		...
		*/
		...
		function apply(ctx) {
			ctx.effect(() => ctx.locale.register(NS, {
				zh,
				en
			}), "ui-remote-control: dictionaries");
