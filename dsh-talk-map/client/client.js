window.__ModuleLoader__.load({ id: "dsh-talk-map", factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region node_modules/.pnpm/@xyflow+react@12.11.3_@type_71dfa8247134ab33b4cd4f58b02b90e3/node_modules/@xyflow/react/dist/esm/index.js
		...
		*/
		...
		const css = ".xUGy9G_toggleButton{width:32px;height:32px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:8px;justify-content:center;align-items:center;gap:6px;padding:0;display:flex}.xUGy9G_toggleButton:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.xUGy9G_toggleButtonActive{background:var(--dsw-alias-interactive-bg-active);color:var(--dsw-alias-brand-primary)}.xUGy9G_toggleRow{width:100%;color:var(--dsw-alias-label-secondary);cursor:pointer;text-align:left;background:0 0;border:none;border-radius:8px;align-items:center;gap:8px;padding:6px 10px;font-size:13px;display:flex}.xUGy9G_toggleRow:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.xUGy9G_toggleLabel{white-space:nowrap}.xUGy9G_toggleIcon{flex:none;width:18px;height:18px}.xUGy9G_overlay{background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-primary);pointer-events:auto;flex-direction:column;display:flex;position:absolute;top:0;bottom:0;left:0;right:0}.xUGy9G_header{border-bottom:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);-webkit-app-region:no-drag;flex:none;align-items:center;gap:10px;padding:36px 150px 8px 14px;display:flex}.xUGy9G_headerTitle{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:600}.xUGy9G_headerBadge{color:var(--dsw-alias-label-tertiary);font-size:12px}.xUGy9G_headerSpace{flex:1}.xUGy9G_hotkeyButton{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);cursor:pointer;white-space:nowrap;background:0 0;border-radius:999px;flex:none;padding:3px 10px;font-size:12px}.xUGy9G_hotkeyButton:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.xUGy9G_langButton{border:1px solid var(--dsw-alias-border-l2);min-width:58px;color:var(--dsw-alias-label-secondary);cursor:pointer;white-space:nowrap;background:0 0;border-radius:999px;flex:none;padding:3px 10px;font-size:12px}.xUGy9G_langButton:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.xUGy9G_zoomResetLabel{letter-spacing:-.5px;font-size:9px;font-weight:700}.xUGy9G_closeButton{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:6px;justify-content:center;align-items:center;padding:0;display:flex}.xUGy9G_closeButton:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.xUGy9G_canvas{flex:1;min-height:0;position:relative}.xUGy9G_canvas .react-flow__nodesselection{pointer-events:none!important;display:none!important}.xUGy9G_canvas .react-flow__nodesselection-rect{pointer-events:none!important;display:none!important}.xUGy9G_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:224px;min-height:104px;color:var(--dsw-alias-label-primary);box-shadow:0 1px 3px var(--dsw-alias-bg-mask-1);border-radius:10px;flex-direction:column;gap:6px;padding:10px 12px;font-size:13px;display:flex}.xUGy9G_cardSelected{border-color:var(--dsw-alias-brand-primary)}.xUGy9G_cardGhost{opacity:.55;border-style:dashed}.xUGy9G_cardTop{align-items:center;gap:6px;min-width:0;display:flex}.xUGy9G_cardTitle{-webkit-line-clamp:2;word-break:break-word;-webkit-box-orient:vertical;font-size:13px;font-weight:600;line-height:1.3;display:-webkit-box;overflow:hidden}.xUGy9G_runningDot{background:var(--dsw-alias-state-success-primary);border-radius:50%;flex:none;width:8px;height:8px;animation:1.6s ease-in-out infinite xUGy9G_talkmap-pulse}@keyframes xUGy9G_talkmap-pulse{50%{opacity:.35}}.xUGy9G_cardNext{color:var(--dsw-alias-label-secondary);align-items:baseline;gap:6px;min-width:0;font-size:12px;display:flex}.xUGy9G_cardNextLabel{color:var(--dsw-alias-brand-primary);flex:none;font-size:11px;font-weight:600}.xUGy9G_cardNextText{-webkit-line-clamp:2;-webkit-box-orient:vertical;display:-webkit-box;overflow:hidden}.xUGy9G_cardStale{color:var(--dsw-alias-state-warn-primary);flex:none;font-size:12px}.xUGy9G_cardFooter{color:var(--dsw-alias-label-tertiary);justify-content:space-between;align-items:center;gap:8px;margin-top:auto;font-size:11px;display:flex}.xUGy9G_cardTime{flex:none}.xUGy9G_cardBadgeRunning{color:var(--dsw-alias-state-success-primary);background:var(--dsw-alias-state-success-tertiary);border-radius:999px;align-items:center;gap:5px;padding:1px 7px;font-size:10px;display:inline-flex}.xUGy9G_cardSummary{color:var(--dsw-alias-label-secondary);-webkit-line-clamp:2;word-break:break-word;-webkit-box-orient:vertical;font-size:12px;line-height:1.45;display:-webkit-box;overflow:hidden}.xUGy9G_cardBadgeWaiting{color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary);border-radius:999px;padding:1px 7px;font-size:10px}.xUGy9G_cardBadgeDone{color:var(--dsw-alias-state-success-primary);background:var(--dsw-alias-state-success-tertiary);border-radius:999px;padding:1px 7px;font-size:10px}.xUGy9G_cardRemove{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border-radius:6px;align-self:flex-start;padding:3px 8px;font-size:12px}.xUGy9G_cardRemove:hover{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.xUGy9G_cardHandle{background:var(--dsw-alias-border-l3);border:2px solid var(--dsw-alias-bg-layer-1);opacity:0;width:10px;height:10px}.xUGy9G_card:hover .xUGy9G_cardHandle,.xUGy9G_canvasConnecting .xUGy9G_cardHandle{opacity:1}.xUGy9G_cardHandle:hover{background:var(--dsw-alias-brand-primary)}.xUGy9G_cardRefresh{width:22px;height:22px;color:var(--dsw-alias-label-tertiary);cursor:pointer;opacity:0;background:0 0;border:none;border-radius:6px;flex:none;margin-left:auto;padding:0;font-size:13px;line-height:1;transition:opacity .12s}.xUGy9G_card:hover .xUGy9G_cardRefresh{opacity:1}.xUGy9G_cardRefresh:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.xUGy9G_cardRefreshBusy{opacity:1;animation:1s linear infinite xUGy9G_talkmap-spin}@keyframes xUGy9G_talkmap-spin{to{transform:rotate(360deg)}}.xUGy9G_spawnPanel{z-index:6;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:420px;max-width:calc(100% - 48px);box-shadow:0 8px 30px var(--dsw-alias-bg-mask-2);border-radius:12px;flex-direction:column;gap:8px;padding:16px;display:flex;position:absolute;top:24px;right:24px}.xUGy9G_spawnHeading{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:600}.xUGy9G_spawnFrom{color:var(--dsw-alias-label-secondary);font-size:12px}.xUGy9G_spawnModes{gap:6px;display:flex}.xUGy9G_spawnModeBtn{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border-radius:8px;flex:1;padding:5px 0;font-size:12px}.xUGy9G_spawnModeBtn:hover{background:var(--dsw-alias-interactive-bg-hover)}.xUGy9G_spawnModeActive{border-color:var(--dsw-alias-brand-primary);color:var(--dsw-alias-brand-primary);background:var(--dsw-alias-interactive-bg-active)}.xUGy9G_spawnHint{color:var(--dsw-alias-label-tertiary);font-size:12px}.xUGy9G_spawnTextarea{resize:vertical;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);width:100%;min-height:140px;color:var(--dsw-alias-label-primary);border-radius:8px;padding:10px;font-family:inherit;font-size:13px;line-height:1.5}.xUGy9G_spawnError{color:var(--dsw-alias-state-error-primary);word-break:break-all;font-size:12px}.xUGy9G_spawnActions{justify-content:flex-end;gap:8px;display:flex}.xUGy9G_spawnBtnPrimary{background:var(--dsw-alias-button-primary-fill);color:var(--dsw-alias-label-primary-foreground);cursor:pointer;border:none;border-radius:8px;padding:6px 16px;font-size:13px}.xUGy9G_spawnBtnPrimary:hover{background:var(--dsw-alias-button-primary-hover)}.xUGy9G_spawnBtnPrimary:disabled{background:var(--dsw-alias-button-primary-dimmed);cursor:default}.xUGy9G_spawnBtnGhost{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border-radius:8px;padding:6px 16px;font-size:13px}.xUGy9G_spawnBtnGhost:hover{background:var(--dsw-alias-interactive-bg-hover)}.xUGy9G_wsFrame{border:1.5px dashed var(--dsw-alias-border-l2);background:0 0;border-radius:16px;position:relative}.xUGy9G_wsFrameSelected{border-style:solid;border-color:var(--dsw-alias-brand-primary)}.xUGy9G_wsFrameLabel{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-secondary);white-space:nowrap;pointer-events:auto;cursor:grab;border-radius:999px;align-items:center;gap:6px;padding:2px 10px;font-size:12px;font-weight:600;display:flex;position:absolute;top:-12px;left:14px}.xUGy9G_wsFrameLabel:active{cursor:grabbing}.xUGy9G_wsFrameEdge{pointer-events:auto;cursor:grab;position:absolute}.xUGy9G_wsFrameEdge:active{cursor:grabbing}.xUGy9G_wsFrameResize{pointer-events:auto;cursor:nwse-resize;border-right:3px solid var(--dsw-alias-border-l3);border-bottom:3px solid var(--dsw-alias-border-l3);opacity:.7;border-bottom-right-radius:14px;width:16px;height:16px;position:absolute;bottom:-2px;right:-2px}.xUGy9G_wsFrameResize:hover{border-color:var(--dsw-alias-brand-primary);opacity:1}.xUGy9G_wsFrameCount{color:var(--dsw-alias-label-tertiary);font-weight:400}.xUGy9G_draftCard{box-sizing:border-box;border:1.5px solid var(--dsw-alias-brand-primary);background:var(--dsw-alias-bg-layer-1);width:360px;box-shadow:0 8px 30px var(--dsw-alias-bg-mask-2);border-radius:12px;flex-direction:column;gap:8px;padding:14px;font-size:13px;display:flex}.xUGy9G_draftHeading{color:var(--dsw-alias-label-primary);font-size:13px;font-weight:600}.xUGy9G_draftRow{align-items:center;gap:8px;display:flex}.xUGy9G_draftLabel{width:52px;color:var(--dsw-alias-label-tertiary);flex:none;font-size:12px}.xUGy9G_draftSelect{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);min-width:0;color:var(--dsw-alias-label-primary);border-radius:7px;flex:1;padding:5px 8px;font-size:12px}.xUGy9G_draftGrow{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}.xUGy9G_draftInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);width:100%;color:var(--dsw-alias-label-primary);border-radius:7px;padding:5px 8px;font-family:inherit;font-size:12px}.xUGy9G_draftPathPreview{color:var(--dsw-alias-label-tertiary);word-break:break-all;font-size:11px}.xUGy9G_draftTextarea{box-sizing:border-box;resize:vertical;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);width:100%;min-height:88px;color:var(--dsw-alias-label-primary);border-radius:8px;padding:9px;font-family:inherit;font-size:13px;line-height:1.5}.xUGy9G_colorToolbar{z-index:7;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);box-shadow:0 2px 10px var(--dsw-alias-bg-mask-1);border-radius:10px;align-items:center;gap:6px;padding:6px 10px;display:flex;position:absolute;top:12px;left:12px}.xUGy9G_colorToolbarLabel{color:var(--dsw-alias-label-tertiary);margin-right:2px;font-size:12px}.xUGy9G_colorSwatch{border:1px solid var(--dsw-alias-border-l2);cursor:pointer;width:18px;height:18px;color:var(--dsw-alias-label-secondary);border-radius:50%;justify-content:center;align-items:center;padding:0;font-size:11px;line-height:1;display:flex}.xUGy9G_colorSwatch:hover{transform:scale(1.15)}.xUGy9G_colorSwatchClear{background:0 0}.xUGy9G_menu{z-index:9;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);min-width:200px;max-width:280px;max-height:380px;box-shadow:0 8px 30px var(--dsw-alias-bg-mask-2);border-radius:10px;flex-direction:column;padding:6px;display:flex;position:absolute;overflow-y:auto}.xUGy9G_menuTitle{color:var(--dsw-alias-label-tertiary);flex:none;padding:4px 10px 6px;font-size:11px}.xUGy9G_menuSearch{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);width:calc(100% - 8px);color:var(--dsw-alias-label-primary);border-radius:7px;flex:none;margin:2px 4px 6px;padding:5px 8px;font-family:inherit;font-size:12px}.xUGy9G_menuHint{color:var(--dsw-alias-label-dimmed);font-size:11px}.xUGy9G_menuPreview{color:var(--dsw-alias-label-tertiary);word-break:break-all;flex:none;padding:0 10px 4px;font-size:11px}.xUGy9G_menuError{color:var(--dsw-alias-state-error-primary);word-break:break-all;flex:none;padding:0 10px 4px;font-size:11px}.xUGy9G_menuEmpty{color:var(--dsw-alias-label-tertiary);padding:8px 10px;font-size:12px}.xUGy9G_menuItem{text-align:left;width:100%;color:var(--dsw-alias-label-primary);cursor:pointer;white-space:nowrap;text-overflow:ellipsis;background:0 0;border:none;border-radius:7px;flex:none;padding:6px 10px;font-size:13px;display:block;overflow:hidden}.xUGy9G_menuItem:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.xUGy9G_menuItem:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.xUGy9G_wsFrameHidden{color:var(--dsw-alias-state-warn-primary);font-weight:400}.xUGy9G_emptyHint{color:var(--dsw-alias-label-tertiary);pointer-events:none;z-index:4;font-size:13px;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.xUGy9G_toast{z-index:8;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);max-width:70%;box-shadow:0 4px 16px var(--dsw-alias-bg-mask-2);color:var(--dsw-alias-label-primary);pointer-events:none;white-space:nowrap;text-overflow:ellipsis;border-radius:999px;padding:7px 16px;font-size:12px;position:absolute;bottom:28px;left:50%;overflow:hidden;transform:translate(-50%)}";
		...
		var talk_map_module_css_default = {
			"cardTop": "xUGy9G_cardTop",
			"spawnBtnPrimary": "xUGy9G_spawnBtnPrimary",
			"wsFrameHidden": "xUGy9G_wsFrameHidden",
			"toggleLabel": "xUGy9G_toggleLabel",
			"cardBadgeRunning": "xUGy9G_cardBadgeRunning",
			"spawnError": "xUGy9G_spawnError",
			"spawnBtnGhost": "xUGy9G_spawnBtnGhost",
			"cardHandle": "xUGy9G_cardHandle",
			"wsFrame": "xUGy9G_wsFrame",
			"draftCard": "xUGy9G_draftCard",
			"wsFrameSelected": "xUGy9G_wsFrameSelected",
			"cardBadgeWaiting": "xUGy9G_cardBadgeWaiting",
			"draftPathPreview": "xUGy9G_draftPathPreview",
			"wsFrameLabel": "xUGy9G_wsFrameLabel",
			"spawnHeading": "xUGy9G_spawnHeading",
			"toggleButton": "xUGy9G_toggleButton",
			"spawnModeActive": "xUGy9G_spawnModeActive",
			"cardFooter": "xUGy9G_cardFooter",
			"cardGhost": "xUGy9G_cardGhost",
			"overlay": "xUGy9G_overlay",
			"menu": "xUGy9G_menu",
			"menuItem": "xUGy9G_menuItem",
			"runningDot": "xUGy9G_runningDot",
			"header": "xUGy9G_header",
			"cardBadgeDone": "xUGy9G_cardBadgeDone",
			"menuTitle": "xUGy9G_menuTitle",
			"menuPreview": "xUGy9G_menuPreview",
			"langButton": "xUGy9G_langButton",
			"emptyHint": "xUGy9G_emptyHint",
			"headerSpace": "xUGy9G_headerSpace",
			"toggleButtonActive": "xUGy9G_toggleButtonActive",
			"toast": "xUGy9G_toast",
			"card": "xUGy9G_card",
			"wsFrameCount": "xUGy9G_wsFrameCount",
			"draftRow": "xUGy9G_draftRow",
			"cardRefresh": "xUGy9G_cardRefresh",
			"canvasConnecting": "xUGy9G_canvasConnecting",
			"menuEmpty": "xUGy9G_menuEmpty",
			"cardTitle": "xUGy9G_cardTitle",
			"draftGrow": "xUGy9G_draftGrow",
			"draftLabel": "xUGy9G_draftLabel",
			"cardTime": "xUGy9G_cardTime",
			"cardNextText": "xUGy9G_cardNextText",
			"spawnTextarea": "xUGy9G_spawnTextarea",
			"draftSelect": "xUGy9G_draftSelect",
			"colorToolbar": "xUGy9G_colorToolbar",
			"canvas": "xUGy9G_canvas",
			"hotkeyButton": "xUGy9G_hotkeyButton",
			"spawnModes": "xUGy9G_spawnModes",
			"draftInput": "xUGy9G_draftInput",
			"spawnFrom": "xUGy9G_spawnFrom",
			"cardNextLabel": "xUGy9G_cardNextLabel",
			"cardSummary": "xUGy9G_cardSummary",
			"headerBadge": "xUGy9G_headerBadge",
			"zoomResetLabel": "xUGy9G_zoomResetLabel",
			"closeButton": "xUGy9G_closeButton",
			"toggleRow": "xUGy9G_toggleRow",
			"draftHeading": "xUGy9G_draftHeading",
			"toggleIcon": "xUGy9G_toggleIcon",
			"talkmap-pulse": "xUGy9G_talkmap-pulse",
			"menuSearch": "xUGy9G_menuSearch",
			"colorSwatchClear": "xUGy9G_colorSwatchClear",
			"spawnPanel": "xUGy9G_spawnPanel",
			"menuError": "xUGy9G_menuError",
			"cardSelected": "xUGy9G_cardSelected",
			"cardRemove": "xUGy9G_cardRemove",
			"spawnActions": "xUGy9G_spawnActions",
			"wsFrameEdge": "xUGy9G_wsFrameEdge",
			"colorToolbarLabel": "xUGy9G_colorToolbarLabel",
			"menuHint": "xUGy9G_menuHint",
			"cardNext": "xUGy9G_cardNext",
			"spawnModeBtn": "xUGy9G_spawnModeBtn",
			"cardStale": "xUGy9G_cardStale",
			"wsFrameResize": "xUGy9G_wsFrameResize",
			"draftTextarea": "xUGy9G_draftTextarea",
			"cardRefreshBusy": "xUGy9G_cardRefreshBusy",
			"talkmap-spin": "xUGy9G_talkmap-spin",
			"spawnHint": "xUGy9G_spawnHint",
			"colorSwatch": "xUGy9G_colorSwatch",
			"headerTitle": "xUGy9G_headerTitle"
		};
		//#endregion
